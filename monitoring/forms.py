...
class ScheduleMaintenanceForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):    	
        ...
        self.fields['cus_id'].widget.attrs = {'class': 'form-control form-control-md col-2', 'placeholder': _('')}
        self.fields['cus_id'].error_messages = {'required': _('Please enter data'), 'max_value': _('Incorrect code')}
        self.fields['cus_brn'].widget.attrs = {'class': 'form-control form-control-md col-2', 'placeholder': _('')}
        self.fields['cus_brn'].error_messages = {'required': _('Please enter data'), 'max_value': _('Incorrect code')}
        self.fields['cus_vol'].widget.attrs = {'class': 'form-control form-control-md col-2', 'placeholder': _('')}
