...
class CusContract(models.Model):
    ...
    cnt_apr_by = models.ForeignKey(TAprove, db_column='cnt_apr_by', to_field='apr_id', on_delete=models.SET_NULL, null=True)
    ...
    cnt_wage_id = models.ForeignKey(TWagezone, related_name='cus_contract_t_wagezone_fk', db_column='cnt_wage_id', to_field='wage_id', on_delete=models.SET_NULL, null=True)
